...
Предлагается на примере шаблона из одного учебного курса, на удобном вам фреймворке реализовать ЧАСТЬ функционала, которая продемонстрирует ваши навыки. Например конструктор пиццы, авторизацию, переключение между страницами. Все задание реалзизвывать не надо, только ту часть которую вы сможете сделать за несколько часов и которая продемонстрирует ваши навыки.

https://github.com/htmlacademy-vue/1393011-pizza-1.git
